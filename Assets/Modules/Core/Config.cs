...
namespace Assets.Modules.Core
{
    ...
    public class Config
    {
        public void Save()
        {
            ...
            {
                Modules.Console.Log($"<color=red>Failed</color> to save Config at {Application.persistentDataPath + "/save.cfg"} {ex.Message} {ex.StackTrace}");
            }
            finally
            {
                file?.Close();
        ...
        public static Config Load()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    result.Save();
                    Modules.Console.Log($"<color=green>Created</color> new Config with default settings");
                }
                else
                {
                    Modules.Console.Log($"<color=red>Failed</color> to open CurrentPlayerConfiguration: {ex.Message} {ex.StackTrace}");
                }
            }
            finally
            {
        ...
        public Task Apply()
        {
            ...
            //    Console(new NotImplementedException());
